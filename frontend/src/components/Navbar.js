    ...
    <>
      ...
      <nav className="bg-white dark:bg-gray-900 shadow-md transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <Link to="/jobs" className="text-gray-600 dark:text-gray-300 hover:text-indigo-600">
              Jobs
            </Link>
      ...
      {menuOpen && (
        <div className="fixed inset-0 bg-black/40 z-50">
          ...
          <div className="fixed top-0 left-0 h-full w-72 bg-white dark:bg-gray-900 shadow-lg p-6 flex flex-col space-y-6 transition-transform">

            <div className="flex justify-between items-center">
              <h2 className="text-xl font-bold text-indigo-600">JobBoard</h2>
